...
[![Category: Mlops](https://img.shields.io/badge/Category-Mlops-purple)](#)

| Field | Value |
| --- | --- |
| **Name** | `weights-and-biases-skill` |
...
cp -r mlops/evaluation/weights-and-biases ~/.hermes/skills/mlops/evaluation/weights-and-biases/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/weights-and-biases-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/weights-and-biases-skill.git ~/.hermes/skills/mlops/evaluation/weights-and-biases/
```
...
```text
skill_view(name="mlops/evaluation/weights-and-biases")
```
...
```text
Use the weights and biases skill to <describe your specific task here>
```
...
```text
Gunakan skill weights and biases untuk <deskripsikan tugas spesifik Anda di sini>
```
